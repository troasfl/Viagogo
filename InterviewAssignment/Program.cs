...
namespace InterviewAssignment
{
    class Program
    {
        private static void Main(string[] args)
        {
           ...
           {
               DisplayScenariosForCustomer(customer, events, emailCampaignService);
           }
           
           Console.ReadLine();
        }

        private static void DisplayScenariosForCustomer(Customer customer, IReadOnlyCollection<Event> events, EmailCampaignService emailCampaignService)
        {
